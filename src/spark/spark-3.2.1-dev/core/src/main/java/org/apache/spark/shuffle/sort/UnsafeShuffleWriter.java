...
public class UnsafeShuffleWriter<K, V> extends ShuffleWriter<K, V> {
  ...
  @Nullable private java.util.Map<Integer, Long> lengthByMicroRddId;
    ...
    if (spills.length == 0) {
      ...
      if (maybeSingleFileWriter.isPresent()) {
        ...
        maybeSingleFileWriter.get()
          .transferMapSpillFile(spills[0].file, partitionLengths, sorter.getChecksums(), lengthByMicroRddId);
      } else {
