...
public class LocalDiskSingleSpillMapOutputWriter
  ...
  public void transferMapSpillFile(
      ...
      long[] checksums,
      java.util.Map<Integer, Long> lengthByMicroRddId) throws IOException {
    ...
    blockResolver
      .tmpWriteMetadataFileAndCommit(shuffleId, mapId, partitionLengths, checksums, tempFile, lengthByMicroRddId);
  }
}
