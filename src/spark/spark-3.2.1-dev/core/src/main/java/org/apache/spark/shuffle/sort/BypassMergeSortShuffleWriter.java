...
final class BypassMergeSortShuffleWriter<K, V>
  ...
  private java.util.Map<Integer, Long> lengthByMicroRddId;
  ...
  public void write(Iterator<Product2<K, V>> records) throws IOException {
    ...
    try {
      if (!records.hasNext()) {
        MapOutputCommitMessage tmp = mapOutputWriter.commitAllPartitions(ShuffleChecksumHelper.EMPTY_CHECKSUM_VALUE);
        partitionLengths = /*mapOutputWriter.commitAllPartitions(
          ShuffleChecksumHelper.EMPTY_CHECKSUM_VALUE)*/tmp.getPartitionLengths();
        lengthByMicroRddId = tmp.getLengthByMicroRddId();
        //System.out.println("lengthByMicroRddId: " + lengthByMicroRddId);
        mapStatus = MapStatus$.MODULE$.apply(
          blockManager.shuffleServerId(), partitionLengths, mapId, null, lengthByMicroRddId, -1);
        return;
      }
  ...
  //@Override
  public java.util.Map<Integer, Long> getLengthByMicroRddId() {
    return lengthByMicroRddId;
  }
