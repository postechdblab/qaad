 ...
 */
public class ExtendedLZ4BlockInputStream extends LZ4BlockInputStream /*extends FilterInputStream*/ {
   ...
   */
  public ExtendedLZ4BlockInputStream(InputStream in, LZ4FastDecompressor decompressor, Checksum checksum, boolean stopOnEmptyBlock) {
    super(in);
   ...
   */
  public ExtendedLZ4BlockInputStream(InputStream in, LZ4FastDecompressor decompressor, Checksum checksum) {
   ...
   */
  public ExtendedLZ4BlockInputStream(InputStream in, LZ4FastDecompressor decompressor) {
   ...
   * @see StreamingXXHash32#asChecksum()
   */
  public ExtendedLZ4BlockInputStream(InputStream in, boolean stopOnEmptyBlock) {
   ...
   * @see LZ4Factory#fastestInstance()
   */
  public ExtendedLZ4BlockInputStream(InputStream in) {
