...
public final class MapOutputCommitMessage {
  ...
  private MapOutputCommitMessage(
      ...
      java.util.Map<Integer, Long> lengthByMicroRddId,
      Optional<MapOutputMetadata> mapOutputMetadata) {
    this.partitionLengths = partitionLengths;
    this.lengthByMicroRddId = lengthByMicroRddId;
  ...
  public static MapOutputCommitMessage of(long[] partitionLengths, java.util.Map<Integer, Long> lengthByMicroRddId) {
    return new MapOutputCommitMessage(partitionLengths, lengthByMicroRddId, Optional.empty());
  }
