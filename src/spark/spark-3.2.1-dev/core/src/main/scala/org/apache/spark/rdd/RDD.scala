...
abstract class RDD[T: ClassTag](
  ...
  final def partitions: Array[Partition] = {
    if (updatedPartitioner != null) {
      this match {
        case rdd: ShuffledRDD[_, _, _] =>
          partitions_ = Array.tabulate[Partition](updatedPartitioner.numPartitions)(i => new org.apache.spark.rdd.ShuffledRDDPartition(i))
        case _ =>
